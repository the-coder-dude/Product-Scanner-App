...
_login_google = async() =>{
  ...
  try {
    const result = await Google.logInAsync({
      ...
      androidClientId: "949582116880-mn2p527vqdo6cih7los79d3ocrg1hh6t.apps.googleusercontent.com",
