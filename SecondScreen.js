...
{/*   */}
            ...
            {/* <TouchableHighlight > */}
             <Text style={{textAlign:'center', color: '#fff',fontSize: 20}} onPress={()=>this.props.navigation.navigate('Details', {
      JSON_ListView_Clicked_Item: this.state.data,})}>{this.state.items}</Text> 
             <View style={{width: DEVICE_WIDTH, flexDirection: 'row',justifyContent: 'space-around'}} >
                <Text style={{color: '#fff',fontSize: 18}} onPress={()=>this.props.navigation.navigate('Details', {
      JSON_ListView_Clicked_Item: this.state.data,})}>{this.state.product}</Text> 
                <Text style={{color: '#fff',fontSize: 18}} onPress={()=>this.props.navigation.navigate('Details', {
      JSON_ListView_Clicked_Item: this.state.data,})}>{this.state.price}</Text> 
...
<View style={{flex: 1, flexDirection: 'row', justifyContent: 'center', borderRadius: 50,position:'absolute',
        ...
        <View style={styles.navBar_out_l}>
         ...
         <View style={styles.navBar_in}>
            ...
            style={styles.icon_bottom_1_2_4}
           />
            <Text style={styles.navText}onPress={()=>alert('Please Search/Scan a Product')}>Order</Text>
        </View>
